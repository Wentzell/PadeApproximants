...
# c++2py ../../c++/PadeApproximant/toto.hpp -p --members_read_only -N PadeApproximant -a PadeApproximant -m toto_module -o toto_module -C pytriqs --cxxflags="-std=c++17"
from cpp2py.wrap_generator import *

# The module
module = module_(full_name = "toto_module", doc = "", app_name = "PadeApproximant")

# Imports
module.add_imports(*[])

# Add here all includes
module.add_include("PadeApproximant/toto.hpp")
...
c = class_(
        ...
        c_type = "PadeApproximant::toto",   # name of the C++ class
